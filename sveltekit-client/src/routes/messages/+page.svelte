...
<div class="grid h-screen grid-cols-6">
	...
	<div class="relative grid h-full grid-cols-1 col-span-3">
        <div class="fixed flex items-center justify-center w-1/2 text-2xl text-white h-1/6 bg-darkblue border-strongpink">
            MOJE PORUKE
        </div>
	...
	<div class="fixed right-0 flex flex-col w-1/3 h-full bg-white">
		...
		<div class="w-full grid-rows-3 overflow-y-auto border-l-2 border-solid h-5/6 border-strongpurple">
			<Calendar>
